  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved timer as @timer" do
        ...
        post :create, {:timer => { "task_id" => "invalid value" }}, valid_session
        assigns(:timer).should be_a_new(Timer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested timer" do
        ...
        Timer.any_instance.should_receive(:update_attributes).with({ "task_id" => "1" })
        put :update, {:id => timer.to_param, :timer => { "task_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the timer as @timer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Timer.any_instance.stub(:save).and_return(false)
        put :update, {:id => timer.to_param, :timer => { "task_id" => "invalid value" }}, valid_session
        assigns(:timer).should eq(timer)
      end
